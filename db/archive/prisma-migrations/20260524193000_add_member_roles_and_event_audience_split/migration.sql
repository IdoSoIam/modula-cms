...
VALUES
    ('adherent', 'Adhérent', 'Rôle associatif adhérent', '#2563eb', 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('benevole', 'Bénévole', 'Rôle associatif bénévole', '#16a34a', 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('equipe_cuisine', 'Équipe de cuisinier', 'Rôle associatif cuisine', '#ea580c', 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('conseil_administration', 'Conseil d''administration', 'Rôle associatif gouvernance', '#7c3aed', 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
