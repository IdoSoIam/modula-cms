        ...
        <template v-else>
          <div class="w-full space-y-5" :class="contentAlignClass(section.column.align)" :style="columnTextStyle(section.column)">
            <template v-if="hasColumnHeaderContent(section.column)">
              ...
              <HomePageEditable v-if="pickLocalizedText(locale, section.column.title)" :editable="editable" label="Texte" @edit="emit('edit', createTextTarget('Titre', section.column.title, section.column, 'titleSize'))">
              <h2 class="font-bold" :class="titleSizeClass(section.column.titleSize)">
                {{ pickLocalizedText(locale, section.column.title) }}
              </h2>
              </HomePageEditable>

              <HomePageEditable v-if="pickLocalizedText(locale, section.column.text)" :editable="editable" label="Texte" @edit="emit('edit', createTextTarget('Texte', section.column.text, section.column, 'textSize', true))">
              <p class="opacity-80" :class="textSizeClass(section.column.textSize)">
            ...
            <div v-if="primaryColumnButton(section.column) || secondaryColumnButton(section.column)" class="flex flex-wrap gap-3 pt-2">
              ...
              <NuxtLink
                ...
                class="btn"
                :class="[buttonClass(primaryColumnButton(section.column)!.tone), buttonSizeClass(primaryColumnButton(section.column)!.size)]"
              ...
              <NuxtLink
                ...
                class="btn"
                :class="[buttonClass(secondaryColumnButton(section.column)!.tone), buttonSizeClass(secondaryColumnButton(section.column)!.size)]"
